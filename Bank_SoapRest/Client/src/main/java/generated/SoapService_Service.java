 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://soapservice/", wsdlLocation = "http://localhost:8080/soap?WSDL")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://soapservice/", "SoapService");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://soapservice/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soapservice/", "SoapServicePort"), SoapService.class, features);
    }
